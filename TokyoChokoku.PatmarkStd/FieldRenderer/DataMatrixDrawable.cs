...
{
	public class DataMatrixDrawable : FieldDrawable
	{
		private readonly DataMatrixParameter p;
        ...
        public DataMatrixDrawable (DataMatrix.Constant mbobject)
		{
