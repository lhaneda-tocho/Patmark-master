...
{
	public class YVerticalTextDrawable : FieldDrawable
	{
		private readonly YVerticalTextParameter p;
        ...
        public YVerticalTextDrawable (YVerticalText.Constant mbobject)
		{
        ...
        private void DrawYVerticalText (
            FieldCanvas canvas,
            ...
            bool mirrored)
        {
            ...
            canvas.DrawFieldTextNode (root, (index) => {
                ...
                m = FieldCanvas.Translate (m, 0, pitch * index);
