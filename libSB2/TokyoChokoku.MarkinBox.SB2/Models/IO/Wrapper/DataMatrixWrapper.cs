...
{
    public class DataMatrixWrapper : BarcodeWrapper
    {
        public DataMatrixWrapper (MBDataStructure data) : base (data) {
        }
        ...
        public float Height {
            get {
                return (float) (Width * new DotCount2D(HorizontalDotCount, VerticalDotCount).AspectHeight);
            }
        }
