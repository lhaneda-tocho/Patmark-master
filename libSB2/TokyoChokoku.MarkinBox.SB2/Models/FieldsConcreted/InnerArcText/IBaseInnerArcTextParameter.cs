...
{
    public partial class IBaseInnerArcTextParameter
    {
        ...
        /// <summary>
        /// Gets the length of the outer text.
        /// </summary>
        /// <value>The length of the outer text.</value>
        public float OuterTextLength
        {
            get {
                return (float) Pitch * ((float) Count() - 1.0f) + (float) Width;
            }
        }
        ...
        public RectangleArea CalcBoundingBox () {
            ...
            double phase = OuterTextLength / OuterRadius;
