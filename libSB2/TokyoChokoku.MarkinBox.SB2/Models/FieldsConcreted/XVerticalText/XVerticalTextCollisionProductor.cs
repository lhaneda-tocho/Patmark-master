...
{
    public class XVerticalTextCollisionProductor
    {

        public static ICollision Create (XVerticalText.Constant target) {
            return CreatePrecision (target);
        }

		public static ICollision CreatePrecision (XVerticalText.Constant target) {
