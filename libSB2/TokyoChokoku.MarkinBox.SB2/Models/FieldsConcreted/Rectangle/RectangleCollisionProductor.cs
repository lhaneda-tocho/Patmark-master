...
{
    public class RectangleCollisionProductor
    {
        private readonly RectangleParameter p;



        public RectangleCollisionProductor (Rectangle.Constant target)
        {
            this.p = target.Parameter;
        }



        public static ICollision Create (Rectangle.Constant target)
        {
            return CreatePrecision (target);
        }

        public static ICollision CreatePrecision (Rectangle.Constant target) {
        ...
        static Homogeneous2D[] CreateRectangle (RectangleParameter p) {
